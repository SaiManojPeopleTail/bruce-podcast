...
export default function Edit({ brand }) {
    ...
    const [preview, setPreview] = useState(brand?.image_url ?? '');
    ...
    return (
        <AuthenticatedLayout header={<h2 className="text-xl font-semibold leading-tight text-gray-800 dark:text-slate-200">Edit brand</h2>}>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                ...
                                setData('image', file);
                                setPreview(file ? URL.createObjectURL(file) : brand?.image_url || '');
                            }}
                        ...
                        {preview && <img src={preview} alt="Brand preview" className="mt-3 h-52 w-full rounded-lg border border-gray-200 object-cover dark:border-gray-700" />}
                    </div>
